...
## v2.5.14修复：
- 从者被动在添加负面效果时现在正确地无视弱化无效
- 修正因螺旋社调整数据结构导致的泳装艾蕾宝具伤害问题
- 支持新泳装BB
  - 支持其被动新添加的生效检测
  - 支持新的宝具更换逻辑
...
- 修正艾蕾好感度与御主技能`洗牌`的交互
  - 将艾蕾放在队伍首位洗牌时可以增加好感度
- 支持泳装XX宝具
- 【高难相关】修正攻击对肃正、无敌、闪避目标时该目标防御类buff的结算
  - 如果该目标的对肃正、无敌、闪避生效，则正面效果的防御类buff不会生效、消耗次数，而负面效果的防御类buff正常生效
  - 如果该目标仍要收到伤害则无变化
- 【高难相关】支持 damageValue 和 damageValueSafe
- 【高难相关】修正敌方单位变化类技能
- 【高难相关】修正 ParamAddFieldIndividuality 的效果
- 【高难相关】支持带有 intervalTurn 的敌方 buff
...
## v2.5.11修复：
- 宝具伤害排行设置的助战无法正确加上buff
- Overkill bug 未在宝具后重置
- 支持泳装艾蕾
